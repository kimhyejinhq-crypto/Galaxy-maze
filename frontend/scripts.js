...
const CHARACTERS = {
  THO:       { id: "THO",       name: "Thỏ Vũ Trụ",      emoji: "🐰", color: "#FF819C" },
  CANH_CUT:  { id: "CANH_CUT",  name: "Cánh Cụt Du Hành", emoji: "🐧", color: "#66C7F4" },
  CAO:       { id: "CAO",       name: "Cáo Phi Hành",     emoji: "🦊", color: "#FFB8E3" },
  QUA:       { id: "QUA",       name: "Quạ Không Gian",     emoji: "🐦‍⬛", color: "#6C6EA0" },
};
...
let cameraMode = 'follow'; // 'follow' hoặc 'full'
